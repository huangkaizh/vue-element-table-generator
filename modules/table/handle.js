...
var tableData = {
  ...
  queryAll: function(req, res, next) {
    ...
    const { columnName, sortType } = parseSort(sort, "create_time", "desc");
    let sqlString = sql.queryAll;
    let sqlTotalString = sql.queryTotal;
    console.log("sqlString: ", sqlString);
    console.log("req.query", req.query);
    let appendString = "";
    let whereString = ` where table_schema = '${mysqlconfig.database}'`;
    if (req.query.TABLE_NAME) {
      whereString += " and TABLE_NAME like '%" + req.query.TABLE_NAME + "%'";
    }
    if (req.query.TABLE_COMMENT) {
      whereString +=
        " and TABLE_COMMENT like '%" + req.query.TABLE_COMMENT + "%'";
    }
    ...
    console.log("sqlTotalString: ", sqlTotalString);
    console.log("sqlString: ", sqlString);
    pool.getConnection(function(err, connection) {
